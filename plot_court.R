...
court = ggplot() + geom_path(data = court_points,
            ...
            color = "#999999") + scale_linetype_manual(values = c("solid", "longdash"), guide = FALSE) + geom_path(data = line_points,aes(x = x, y = y, group = "dottedLine", linetype = "solid")) + coord_fixed(ylim = c(0, 30), xlim = c(-27, 27)) +
